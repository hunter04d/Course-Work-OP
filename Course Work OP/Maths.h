...
namespace Maths
{
	...
	namespace Calculus 
	{
		...
		T_matrix jacobiMatrix(const std::vector<std::string>& _funcs, const std::vector<double>& _point); // prototype of a function to get the Jacobi matrix of functions _funcs at point _point
	}
